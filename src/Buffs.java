        ...
        switch(buff){
            ...
            case "Revivir al primer personaje que murio":
                if (muertosJugador.isEmpty()){
                    ...
                    String mensaje="Se revivio a "+muerto.getNombre()+"'"+muerto.getApodo()+"con 50 de vida";
